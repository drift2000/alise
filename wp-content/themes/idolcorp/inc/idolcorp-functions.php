...
if (!function_exists('idolcorp_custom_layout_class_and_structure')) :
    ...
    function idolcorp_custom_layout_class_and_structure($layout = 'primary')
    {
        ...
        if ($post) {
            $sidebar_meta = get_post_meta($post->ID, 'idolcorp_page_sidebar', true);
        }
        ...
        if (empty($sidebar_meta) || is_archive() || is_search()) {
            $sidebar_meta = 'default_sidebar';
        }
        ...
        if ($sidebar_meta === 'default_sidebar') {
            if (is_page()) {
                if ($idolcorp_default_page_sidebar === 'right_sidebar') {
                    $sidebar_classes = 'col-sm-4';
                    $primary_classes='col-sm-8';
                } elseif ($idolcorp_default_page_sidebar === 'left_sidebar') {
                    $sidebar_classes = 'col-sm-4 col-sm-pull-8';
                    $primary_classes='col-sm-8 col-sm-push-4';
                } elseif ($idolcorp_default_page_sidebar === 'no_sidebar_full_width') {
                    $sidebar_classes = '';
                    $primary_classes='col-sm-12';
                }
            } elseif (is_single()) {
                if ($idolcorp_default_post_sidebar == 'right_sidebar') {
                    $sidebar_classes = 'col-sm-4';
                    $primary_classes='col-sm-8';
                } elseif ($idolcorp_default_post_sidebar == 'left_sidebar') {
                    $sidebar_classes = 'col-sm-4 col-sm-pull-8';
                    $primary_classes='col-sm-8 col-sm-push-4';
                } elseif ($idolcorp_default_post_sidebar == 'no_sidebar_full_width') {
                    $sidebar_classes = '';
                    $primary_classes='col-sm-12';
                }
            } elseif ($idolcorp_default_sidebar == 'right_sidebar') {
                $sidebar_classes = 'col-sm-4';
                $primary_classes='col-sm-8';
            } elseif ($idolcorp_default_sidebar == 'left_sidebar') {
                $sidebar_classes = 'col-sm-4 col-sm-pull-8';
                $primary_classes='col-sm-8 col-sm-push-4';
            } elseif ($idolcorp_default_sidebar == 'no_sidebar_full_width') {
                $sidebar_classes = '';
                $primary_classes='col-sm-12';
            }
        } elseif ($sidebar_meta == 'right_sidebar') {
            $sidebar_classes = 'col-sm-4';
            $primary_classes='col-sm-8';
        } elseif ($sidebar_meta == 'left_sidebar') {
            $sidebar_classes = 'col-sm-4 col-sm-pull-8';
            $primary_classes='col-sm-8 col-sm-push-4';
        } elseif ($sidebar_meta == 'no_sidebar_full_width') {
            $sidebar_classes = '';
            $primary_classes='col-sm-12';
        }
    ...
    function idolcorp_top_header()
    {
     ...
     <section class="hgroup-right">
                <?php if (!empty($top_phone)) {
                    ?><div class="caller"><a class="fa-phone" href="tel:<?php echo preg_replace('/(\W*)/', '', esc_attr($top_phone)); ?>" title="<?php echo esc_attr__('our number', 'idolcorp');?>" target="_blank"><?php echo esc_attr($top_phone); ?></a>
                <?php } ?>
              <div class="inline-social-profiles">
                <ul>
                  <?php if (!empty($top_fb)) {
                        ?><li><a class="fa-facebook-f" href="<?php echo esc_url($top_fb); ?>" title="Facebook" target="_blank"></a></li><?php
                  } ?>
                  <?php if (!empty($top_tw)) {
                        ?><li><a class="fa-twitter" href="<?php echo esc_url($top_tw); ?>" title="Twitter" target="_blank"></a></li><?php
                  } ?>
                  <?php if (!empty($top_lnk)) {
                        ?><li><a class="fa-linkedin" href="<?php echo esc_url($top_lnk); ?>" title="Linkedin" target="_blank"></a></li><?php
                  } ?>
                  <?php if (!empty($top_gp)) {
                        ?><li><a class="fa-google-plus" href="<?php echo esc_url($top_gp); ?>" title="Google Plus" target="_blank"></a></li><?php
                  } ?>
                  <?php if (!empty($top_yt)) {
                        ?><li><a class="fa-youtube" href="<?php echo esc_url($top_yt); ?>" title="Youtube" target="_blank"></a></li><?php
                  } ?>
                  <?php if (!empty($top_vm)) {
                        ?><li><a class="fa-vimeo-square" href="<?php echo esc_url($top_vm); ?>" title="Vimeo" target="_blank"></a></li><?php
                  } ?>
